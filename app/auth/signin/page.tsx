      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-col items-center gap-4 pt-8 pb-10 px-6 md:hidden">
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-muted-foreground text-sm">Sign in to your EarlyBird account</p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col md:items-center md:justify-center md:px-16">
          ...
          <div className="hidden md:block mb-8 w-full max-w-sm">
            <h1 className="text-2xl font-bold tracking-tight">Welcome back</h1>
            <p className="text-muted-foreground text-sm mt-1">Sign in to your EarlyBird account</p>
          </div>

          <form onSubmit={handleSignIn} className="flex-1 flex flex-col px-6 gap-5 md:flex-none md:w-full md:max-w-sm md:px-0">
